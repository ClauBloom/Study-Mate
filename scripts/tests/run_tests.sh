...
#   bash scripts/tests/run_tests.sh              # 10 套快测
...
step '安装脚本（沙箱 HOME，16 项）'        python3 scripts/tests/test_install.py
...
step '课件渲染（渲染器，19 例）'           python3 scripts/tests/test_render_lesson.py
step '提示词规则清单（341 条）'            python3 scripts/tests/test_skill_rules.py
