...
1. **先落盘**：每个文件写到暂存目录 `<subject_path>/.stage/practice-evaluator-<节点id>/deliver/<相对路径>`——**相对路径与正式位置一一对应**（`lessons/<序号>-<节点id>.md`、`lessons/<序号>-<节点id>.quiz.json`、`lab/NNNN-主题/main.cpp`、`lab/solutions/NNNN-主题/README.md`…），总控只 `cp` 搬、不读内容
